...
BACKEND_BIN="$ROOT_DIR/dist/backend/sgodai-backend"
...
"$ROOT_DIR/scripts/build_macos_backend.sh"
...
rm -rf "$APP_PATH/Contents/Resources/backend" "$APP_PATH/Contents/Resources/configs"
mkdir -p "$APP_PATH/Contents/Resources/backend"
ditto "$BACKEND_BIN" "$APP_PATH/Contents/Resources/backend/sgodai-backend"
ditto "$ROOT_DIR/configs" "$APP_PATH/Contents/Resources/configs"
